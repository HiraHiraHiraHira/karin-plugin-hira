...
describe('Hira custom config page', () => {
  ...
  it('exposes every default config field in the custom page', () => {
    ...
    const requiredPaths = [
      ...
      'resolver.platforms.bilibili',
      'resolver.platforms.douyin',
      'resolver.platforms.kuaishou',
      'resolver.platforms.weibo',
      'resolver.platforms.tieba',
      'resolver.platforms.xiaoheihe',
      'resolver.platforms.xiaohongshu',
      'resolver.platforms.general',
      'resolver.sending.contentForwardEnabled',
      'resolver.sending.videoFailureFallbackEnabled',
      'resolver.media.dedupeImages',
      'resolver.media.filterLowQualityImages',
      'resolver.media.inlinePreviewCover',
      'resolver.diagnostics.stageLogsEnabled',
      'resolver.diagnostics.verboseLogsEnabled',
