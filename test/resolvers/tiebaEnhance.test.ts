...
describe('normalizeTiebaPost', () => {
  ...
  it('normalizes title, text, author, images and comments', () => {
      ...
      posts: [
        {
          ...
          replyTo: '楼主',
          content: '<p>回复内容</p><img src="https://img/c.jpg">',
    ...
    expect(result.images).toEqual(['https://img/a.jpg', 'https://img/c.jpg', 'https://img/b.jpg'])
    expect(result.extras?.coverUrl).toBe('https://img/a.jpg')
    expect(result.extras?.tags).toEqual(['大学食堂吧'])
    ...
    expect(result.extras?.commentBlocks).toEqual([
      {
        ...
        time: '2026-06-18 12:00',
        text: '回复内容',
        images: ['https://img/c.jpg', 'https://img/b.jpg']
      }
    ])
  })
  ...
  it('normalizes HIBI-style tieba post lists', () => {
    const result = normalizeHibiTiebaPost('https://tieba.baidu.com/p/123', {
      ...
      post_list: [
        ...
        },
        {
          ...
          floor_no: 2,
          ip_location: '广东',
          time: '2026-06-18 10:02',
          quote_user_name: '楼主',
          content: [
            { text: '回复' },
            { cdn_src: 'https://img/b.jpg' }
          ]
        }
      ]
    })
    ...
    expect(result.extras?.coverUrl).toBe('https://img/a.jpg')
    expect(result.extras?.tags).toEqual(['校园生活吧'])
    expect(result.extras?.commentBlocks).toEqual([
      {
        author: '层主',
        replyTo: '楼主',
